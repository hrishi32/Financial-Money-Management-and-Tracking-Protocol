...
<body>
	<?php 
		...
		if(isset($_POST['submitbtn'])&&isset($_FILES['fileToUpload']))
		{
            ...
            if($check !== false) 
            {
            	move_uploaded_file($tmp_name,$target_dir.$bill_name);
		    
		    	$sql = "INSERT INTO Bills (BillId,amount,audited,location,accId,remarks) VALUES ('$current_bill_id','$amnt','0','$target_dir . $bill_name','$acc_id','$remarks')";

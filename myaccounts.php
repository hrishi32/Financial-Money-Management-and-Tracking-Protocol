...
$result = mysqli_query($db,$sql);
	...
	{ 	
				...
				<div  class="item_divs_for_feed_in_search_acc"  >
							...
							<div class="container">
								...
								<img src="Icons/acc.png"  class="avatar">

								<h3><strong>Account number:</strong> <?php echo $row['accId']; $accId=$row['accId'] ?>
								</a></h3>
